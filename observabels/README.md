...
In a custom observable we can manually complete it calling `observe.complete()` (see ([home.component.ts](https://github.com/ebd622/fe-samples/blob/master/observabels/src/app/home/home.component.ts)).
